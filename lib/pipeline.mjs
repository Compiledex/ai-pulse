...
export function reusePrevious(items, previousItems = []) {
  ...
  return items.map((item) => {
    ...
    // An AI illustration made for this story is kept (pool covers are re-picked every build).
    if (!item.cover && prev.cover?.startsWith('covers/story/')) next.cover = prev.cover;
